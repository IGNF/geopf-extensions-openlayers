...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GetFeatureInfoDOM);

/***/ }),

/***/ "./src/packages/Controls/Utils/Gfi.js":
/*!********************************************!*\
  !*** ./src/packages/Controls/Utils/Gfi.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var ol_source_VectorTile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ol/source/VectorTile */ "ol/source/VectorTile");
...
/* harmony import */ var ol_source_Vector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ol/source/Vector */ "ol/source/Vector");
...
/* harmony import */ var ol_source_TileWMS__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ol/source/TileWMS */ "ol/source/TileWMS");
...
/* harmony import */ var ol_source_WMTS__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ol/source/WMTS */ "ol/source/WMTS");
...
/* harmony import */ var ol_source_ImageWMS__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ol/source/ImageWMS */ "ol/source/ImageWMS");
...
/* harmony import */ var ol_interaction__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ol/interaction */ "ol/interaction");
...
/* harmony import */ var geoportal_access_lib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! geoportal-access-lib */ "./node_modules/geoportal-access-lib/src/Gp.js");
...
/* harmony import */ var _Utils_ProxyUtils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../Utils/ProxyUtils */ "./src/packages/Utils/ProxyUtils.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
// import OpenLayers
...
var logger = _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_8__["default"].getLogger("GfiUtils");
var Gfi = {
  /**
   * Return layer format
   *
  ...
  getLayerFormat: function getLayerFormat(l) {
    ...
    if (type) {
      ...
      if (source instanceof (ol_source_TileWMS__WEBPACK_IMPORTED_MODULE_3___default()) || source instanceof (ol_source_ImageWMS__WEBPACK_IMPORTED_MODULE_5___default())) {
        return "wms";
      }
      if (source instanceof (ol_source_WMTS__WEBPACK_IMPORTED_MODULE_4___default())) {
        return "wmts";
      }
      if (source instanceof (ol_source_Vector__WEBPACK_IMPORTED_MODULE_2___default()) || source instanceof (ol_source_VectorTile__WEBPACK_IMPORTED_MODULE_1___default())) {
        return "vector";
      }
    }
    return "unknown";
  ...
  displayInfo: function displayInfo(map, coords, content, contentType, autoPanOptions) {
    ...
    */
    ...
    map.featuresOverlay = new (ol_Overlay__WEBPACK_IMPORTED_MODULE_0___default())({
      // id : id,
      element: element,
  ...
  features2html: function features2html(map, features) {
    ...
    features.forEach(function (f) {
      ...
      if (props.hasOwnProperty("render")) {
        ...
        var listForbidden = [
        // styles
        "fill", "fill-opacity", "stroke", "stroke-opacity", "stroke-width", "marker-symbol", "marker-color", "marker-size", "geometry",
        // geometrie
        "value", "name",
        // déjà traité
        "description",
        // déjà traité
        "styleUrl", "extensionsNode_",
        // extensions GPX
      ...
      for (var h = 0; h < layersOrdered[p].length; ++h) {
        ...
        if (l.getVisible() && minMaxResolutionOk) {
          ...
          requests.push({
            // id : _id,
            format: infoFormat,
            url: _Utils_ProxyUtils__WEBPACK_IMPORTED_MODULE_9__["default"].proxifyUrl(_url, proxyOptions),
            scope: this,
            coordinate: olCoordinate
          });
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Gfi);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CSS_Controls_GetFeatureInfo_GPFgetFeatureInfo_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../CSS/Controls/GetFeatureInfo/GPFgetFeatureInfo.css */ "./src/packages/CSS/Controls/GetFeatureInfo/GPFgetFeatureInfo.css");
...
/* harmony import */ var _Utils_Gfi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Utils/Gfi */ "./src/packages/Controls/Utils/Gfi.js");
/* harmony import */ var _GetFeatureInfoDOM__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./GetFeatureInfoDOM */ "./src/packages/Controls/GetFeatureInfo/GetFeatureInfoDOM.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var logger = _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_3__["default"].getLogger("getfeatureinfo");
 ...
 */
var GetFeatureInfo = /*#__PURE__*/function (_Control) {
  /**
  ...
  function GetFeatureInfo(options) {
    ...
    _this = _callSuper(this, GetFeatureInfo, [{
      element: _options.element,
      target: _options.target,
      render: _options.render
    }]);
    if (!(_this instanceof GetFeatureInfo)) {
    ...
    _this._container = _this._initContainer(_options);
  ...
  _inherits(GetFeatureInfo, _Control);
  return _createClass(GetFeatureInfo, [{
    key: "_initialize",
    value:
    // ################################################################### //
    // ######################## initialize control ####################### //
     ...
     * @private
     */
    function _initialize(options, layers) {
      // identifiant du contrôle : utile pour suffixer les identifiants CSS (pour gérer le cas où il y en a plusieurs dans la même page)
      this._uid = _Utils_SelectorID__WEBPACK_IMPORTED_MODULE_2__["default"].generate();
      this.options = options;
      ...
      this._activateGetFeatureInfoButton = null;
    }
    ...
    value: function setMap(map) {
      ...
      if (map) {
        ...
        map.getLayers().on("remove", function (evt) {
          for (var i = 0; i < _this2._layers.length; ++i) {
            if (_this2._layers[i].obj === evt.element) {
              _this2._layers.splice(i, 1);
              break;
            }
          }
          _this2._updateEvents(map);
        });
        if (this._auto) {
          // ajout des couches vecteur deja dans la carte
          var updated = false;
          map.getLayers().forEach(function (olLayer) {
            var layerFormat = _Utils_Gfi__WEBPACK_IMPORTED_MODULE_4__["default"].getLayerFormat(olLayer);
            if (!_this2._hasLayer(olLayer) && layerFormat === "vector") {
              _this2._layers.push({
                obj: olLayer
              });
              updated = true;
          ...
          map.getLayers().on("add", function (evt) {
            var layerFormat = _Utils_Gfi__WEBPACK_IMPORTED_MODULE_4__["default"].getLayerFormat(evt.element);
      ...
      _get(_getPrototypeOf(GetFeatureInfo.prototype), "setMap", this).call(this, map);
    ...
    key: "setDefaultEvent",
    value: function setDefaultEvent(eventName) {
    ...
    value: function setActive(active) {
      ...
      this._activateGetFeatureInfoButton.setAttribute("aria-pressed", active);
    }
    ...
    key: "setLayers",
    value: function setLayers(gfiLayers) {
    ...
    key: "_activateEvent",
    value: function _activateEvent(eventName, map) {
      var gfiObj = this;
      var getFeatureInfoHandler = function getFeatureInfoHandler(e) {
        _Utils_Gfi__WEBPACK_IMPORTED_MODULE_4__["default"].onDisplayFeatureInfo(e, gfiObj);
      };
    ...
    key: "_deactivateEvent",
    value: function _deactivateEvent(eventName, map) {
      if (eventName === "contextmenu") {
    ...
    key: "_updateEvents",
    value: function _updateEvents(map) {
      if (!map) {
        map = this.getMap();
      }
      var sEvent = [];
    ...
    key: "_hasLayer",
    value: function _hasLayer(olLayer) {
      for (var i = 0; i < this._layers.length; ++i) {
    ...
    key: "_activateCursor",
    value: function _activateCursor(activate, map) {
      if (!map) {
        map = this.getMap();
      }
      if (activate) {
    ...
    key: "_setLayers",
    value: function _setLayers(gfiLayers) {
    ...
    key: "onActivateGetFeatureInfoElementChange",
    value: function onActivateGetFeatureInfoElementChange(e) {
      var opened = e.target.getAttribute("aria-pressed");
      this._setActive(opened === "true");
    }
    ...
    key: "_initContainer",
    value: function _initContainer(options) {
...
// on récupère les méthodes de la classe commune GetFeatureInfo
Object.assign(GetFeatureInfo.prototype, _GetFeatureInfoDOM__WEBPACK_IMPORTED_MODULE_5__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GetFeatureInfo);
...
GetFeatureInfo = __webpack_exports__["default"];
/******/ })()
;
//# sourceMappingURL=GetFeatureInfo.js.map