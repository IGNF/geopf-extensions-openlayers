...
/***/ "./src/packages/Controls/Measures/MeasureAzimuthDOM.js":
/*!*************************************************************!*\
  !*** ./src/packages/Controls/Measures/MeasureAzimuthDOM.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var MeasureAzimuthDOM = {
  ...
  */
  ...
  _createShowMeasureAzimuthPictoElement: function _createShowMeasureAzimuthPictoElement() {
    ...
    button.className = "GPshowOpen GPshowAdvancedToolPicto gpf-btn gpf-btn-icon gpf-btn-icon-azimuth fr-btn";
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MeasureAzimuthDOM);
...
/***/ "./src/packages/CSS/Controls/Measures/GPFmeasureAzimuth.css":
/*!******************************************************************!*\
  !*** ./src/packages/CSS/Controls/Measures/GPFmeasureAzimuth.css ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!**********************************************************!*\
  !*** ./src/packages/Controls/Measures/MeasureAzimuth.js ***!
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CSS_Controls_Measures_GPFmeasureAzimuth_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../CSS/Controls/Measures/GPFmeasureAzimuth.css */ "./src/packages/CSS/Controls/Measures/GPFmeasureAzimuth.css");
/* harmony import */ var _Control__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Control */ "./src/packages/Controls/Control.js");
...
/* harmony import */ var _MeasureAzimuthDOM__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./MeasureAzimuthDOM */ "./src/packages/Controls/Measures/MeasureAzimuthDOM.js");
/* harmony import */ var _ToolBoxMeasure_MeasureToolBox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ToolBoxMeasure/MeasureToolBox */ "./src/packages/Controls/ToolBoxMeasure/MeasureToolBox.js");
/* harmony import */ var _Measures__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Measures */ "./src/packages/Controls/Measures/Measures.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var logger = _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_4__["default"].getLogger("measureazimut");
 ...
 * });
 */
var MeasureAzimuth = /*#__PURE__*/function (_Control) {
  function MeasureAzimuth(options) {
    var _this;
    _classCallCheck(this, MeasureAzimuth);
    /**
     * options
     * @private
     */
    ...
    // call ol.control.Control constructor
    _this = _callSuper(this, MeasureAzimuth, [{
      element: options.element,
      target: options.target,
      render: options.render
    }]);
    if (!(_this instanceof MeasureAzimuth)) {
      throw new TypeError("ERROR CLASS_CONSTRUCTOR");
    }
     ...
     * @private
     */
    _this.CLASSNAME = "MeasureAzimuth";
   ...
   * @param {ol.Map} map - Map.
   */
  _inherits(MeasureAzimuth, _Control);
  return _createClass(MeasureAzimuth, [{
    key: "setMap",
    value: function setMap(map) {
      logger.trace("setMap()");
      ...
      if (map) {
        ...
        if (!this.options.target && !this.options.position) {
          _ToolBoxMeasure_MeasureToolBox__WEBPACK_IMPORTED_MODULE_7__["default"].add(map, this);
        }
      } else {
        this.clean();
      }
      ...
      // on appelle la méthode setMap originale d'OpenLayers
      _get(_getPrototypeOf(MeasureAzimuth.prototype), "setMap", this).call(this, map);
    ...
    key: "setGeodesic",
    value: function setGeodesic(value) {
    ...
    value: function removeMeasureEvents() {
      ...
      map.un("singleclick", function (e) {
        return _this3.onPointerMoveAzimutHandler(e);
      });
    ...
    key: "format",
    value: function format(line) {
      logger.trace("call MeasureAzimuth::format()");
      var map = this.getMap();
      var sourceProj = map.getView().getProjection();
      var c1 = (0,ol_proj__WEBPACK_IMPORTED_MODULE_3__.transform)(line.getFirstCoordinate(), sourceProj, "EPSG:4326");
      var c2 = (0,ol_proj__WEBPACK_IMPORTED_MODULE_3__.transform)(line.getLastCoordinate(), sourceProj, "EPSG:4326");
      if (!this.options.geodesic) {
        // TODO calcul sur une petite distance (>500m) afin de simuler un cap !
        var lengthGeodesic = (0,ol_sphere__WEBPACK_IMPORTED_MODULE_2__.getDistance)(c1, c2);
        ...
        if (lengthGeodesic > 500) {
          ...
          c2 = (0,ol_proj__WEBPACK_IMPORTED_MODULE_3__.transform)(line.getCoordinateAt(fraction), sourceProj, "EPSG:4326");
        }
      }
    ...
    key: "onShowMeasureAzimuthClick",
    value: function onShowMeasureAzimuthClick(e) {
    ...
    key: "onPointerMoveAzimutHandler",
    value: function onPointerMoveAzimutHandler(e) {
...
// de "Measures".
Object.assign(MeasureAzimuth.prototype, _Measures__WEBPACK_IMPORTED_MODULE_8__["default"]);
Object.assign(MeasureAzimuth.prototype, _MeasureAzimuthDOM__WEBPACK_IMPORTED_MODULE_6__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MeasureAzimuth);
...
MeasureAzimuth = __webpack_exports__["default"];
/******/ })()
;
//# sourceMappingURL=MeasureAzimuth.js.map