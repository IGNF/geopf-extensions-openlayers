...
/***/ "./src/packages/Controls/Measures/MeasureLengthDOM.js":
/*!************************************************************!*\
  !*** ./src/packages/Controls/Measures/MeasureLengthDOM.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MeasureLengthDOM);
...
/***/ "./src/packages/CSS/Controls/Measures/GPFmeasureLength.css":
/*!*****************************************************************!*\
  !*** ./src/packages/CSS/Controls/Measures/GPFmeasureLength.css ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!*********************************************************!*\
  !*** ./src/packages/Controls/Measures/MeasureLength.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CSS_Controls_Measures_GPFmeasureLength_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../CSS/Controls/Measures/GPFmeasureLength.css */ "./src/packages/CSS/Controls/Measures/GPFmeasureLength.css");
/* harmony import */ var _Control__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Control */ "./src/packages/Controls/Control.js");
...
/* harmony import */ var _MeasureLengthDOM__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./MeasureLengthDOM */ "./src/packages/Controls/Measures/MeasureLengthDOM.js");
...
var logger = _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_4__["default"].getLogger("measurelength");
 ...
 * });
 */
var MeasureLength = /*#__PURE__*/function (_Control) {
  function MeasureLength(options) {
    ...
    // call ol.control.Control constructor
    _this = _callSuper(this, MeasureLength, [{
      element: options.element,
      target: options.target,
      render: options.render
    }]);
    if (!(_this instanceof MeasureLength)) {
      throw new TypeError("ERROR CLASS_CONSTRUCTOR");
    }

    // Nom de la classe (heritage)
    _this.CLASSNAME = "MeasureLength";
   ...
   * @param {ol.Map} map - Map.
   */
  _inherits(MeasureLength, _Control);
  return _createClass(MeasureLength, [{
    ...
    value: function setMap(map) {
      ...
      // on appelle la méthode setMap originale d'OpenLayers
      _get(_getPrototypeOf(MeasureLength.prototype), "setMap", this).call(this, map);
    ...
    value: function removeMeasureEvents() {
      ...
      map.un("singleclick", function (e) {
        return _this3.onPointerMoveHandle(e);
      });
    ...
    value: function format(line) {
      ...
      if (this.options.geodesic) {
        ...
        for (var i = 0, ii = coordinates.length - 1; i < ii; ++i) {
          var c1 = (0,ol_proj__WEBPACK_IMPORTED_MODULE_3__.transform)(coordinates[i], sourceProj, "EPSG:4326");
          var c2 = (0,ol_proj__WEBPACK_IMPORTED_MODULE_3__.transform)(coordinates[i + 1], sourceProj, "EPSG:4326");
          measure += (0,ol_sphere__WEBPACK_IMPORTED_MODULE_2__.getDistance)(c1, c2);
        }
      } else {
    ...
    key: "onShowMeasureLengthClick",
    value: function onShowMeasureLengthClick(e) {
...
// de "Measures".
Object.assign(MeasureLength.prototype, _Measures__WEBPACK_IMPORTED_MODULE_8__["default"]);
Object.assign(MeasureLength.prototype, _MeasureLengthDOM__WEBPACK_IMPORTED_MODULE_6__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MeasureLength);
...
MeasureLength = __webpack_exports__["default"];
/******/ })()
;
//# sourceMappingURL=MeasureLength.js.map