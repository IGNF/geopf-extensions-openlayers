...
var GetFeatureInfo = class GetFeatureInfo extends Control {
    ...
    constructor (options) {
        ...
        this._container = this._initContainer(_options);
    ...
    _activateEvent (eventName, map) {
        ...
        console.log(this._eventsHandler[eventName]);
     ...
     * @private
     */
    _deactivateEvent (eventName, map) {
        if (eventName === "contextmenu") {
     ...
     * @private
     */
    onActivateGetFeatureInfoElementChange (e) {
