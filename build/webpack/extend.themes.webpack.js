    ...
    return {
        entry : {
            ...
            "Classic" : [
                ...
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "GPFtoggleStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "GPFpanelStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "GPFtabNavStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Draw", "GPFdrawStyle.scss"),
                ...
                path.join(rootdir, "src", "packages", "CSS", "Controls/ContextMenu", "GPFsimpleMenuStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Reporting", "GPFreportingStyle.css"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Input", "GPFinputColorStyle.scss"),
            ...
            "Dsfr" : [
                ...
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "DSFRtoggleStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "DSFRpanelStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Toggle", "DSFRtabNavStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Draw", "DSFRdrawStyle.scss"),
                ...
                path.join(rootdir, "src", "packages", "CSS", "Controls/ContextMenu", "DSFRsimpleMenuStyle.scss"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Reporting", "DSFRreportingStyle.css"),
                path.join(rootdir, "src", "packages", "CSS", "Controls/Input", "DSFRinputColorStyle.scss"),
